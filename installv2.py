...
#faz o dow do cobalt para a seu micro
cobalt = int(input("voce quer fazer o dowload do cobalt para a sua maquina '1' sim '2' nao ")
if cobalt == 1:
  print ("voce disse que sim , vamos iniciar agora 
  system.os("wget https://www.cobaltstrike.com/downloads/e2ed5d02d1c695e62a60105f79708e8f/cobaltstrike-trial.zip")
  system.os("gunzip cobaltstrike-trial.zip")
  system.os("cd cobaltstrike-trial")
  system.os(./c
